...
# Format checker for CS3700 Web Crawler Project at Northeastern University
import os
import sys
import argparse
import subprocess
...
def check_secret_flags(project_dir):
    ...
    for line in f:
        ...
        if len(extract_flag.encode("utf-8")) == 64:
            flag_count += 1
    if flag_count < 10:
        print('The secret_flags file contains less than 10 secret flags, make sure to add missing flags')
